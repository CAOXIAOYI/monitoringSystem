       ...
       <div className="sub-index">
          ...
          <switch>
            ...
            <text transform="matrix(0.8712 0 0 1 1142.5332 406.9007)" className="non-stroke st11 st6">
              <tspan x="0" y="0" className="non-stroke st6 st2">I: {this.getValue(monPoint31.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint31.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint31.q)}</tspan>
            </text>
            ...
            <text transform="matrix(0.8712 0 0 1 630.6738 540.2806)" className="non-stroke st11 st6">
              <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint19.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint19.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint19.q)}</tspan>
            </text>
            ...
            <text transform="matrix(0.8712 0 0 1 318.793 540.9368)" className="non-stroke st11 st6">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint20.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint20.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint20.q)}</tspan>
            </text>
            ...
            <text transform="matrix(0.8712 0 0 1 318.793 710.3001)" className="non-stroke st11 st6">
              <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint22.i)}</tspan>
              <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint22.p)}</tspan>
              <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint22.q)}</tspan>
            </text>
            ...
            <text transform="matrix(0.8712 0 0 1 318.71 880.806)" className="non-stroke st11 st6">
              <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint26.i)}</tspan>
              <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint26.p)}</tspan>
              <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint26.q)}</tspan>
            </text>
            ...
            <text transform="matrix(0.8712 0 0 1 630.0605 700.8587)" className="non-stroke st11 st6">
               <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint21.i)}</tspan>
              <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint21.p)}</tspan>
              <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint21.q)}</tspan>
            </text>
            ...
            <text transform="matrix(0.8712 0 0 1 630.6738 880.3646)" className="non-stroke st11 st6">
              <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint25.i)}</tspan>
              <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint25.p)}</tspan>
              <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint25.q)}</tspan>
            </text>
            ...
            <text transform="matrix(0.8712 0 0 1 1120.2568 540.9808)" className="non-stroke st11 st6">
              <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint23.i)}</tspan>
              <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint23.p)}</tspan>
              <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint23.q)}</tspan>
            </text>
            ...
            <text transform="matrix(0.8712 0 0 1 1120.874 790.6292)" className="non-stroke st11 st6">
              <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint27.i)}</tspan>
              <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint27.p)}</tspan>
              <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint27.q)}</tspan>
            </text>
            ...
            <text transform="matrix(0.8712 0 0 1 1437.2178 540.9798)" className="non-stroke st11 st6">
               <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint24.i)}</tspan>
              <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint24.p)}</tspan>
              <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint24.q)}</tspan>
            </text>
            ...
            <text transform="matrix(0.8712 0 0 1 1437.2178 790.2191)" className="non-stroke st11 st6">
              <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint28.i)}</tspan>
              <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint28.p)}</tspan>
              <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint28.q)}</tspan>
            </text>
