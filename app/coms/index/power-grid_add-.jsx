        ...
        <svg id="path_1" className="power-svg" viewBox="100 80 1700 1130" preserveAspectRatio="xMidYMid meet">
          <switch>
            <g className="zoom-container" id="path_1_g">
              ...
              <line id="polyline_2_11_" className="st0" x1="160" y1="530.9" x2="159.8" y2="569.3"/>
              ...
              <text transform="matrix(0.8712 0 0 1 378.4423 410.5004)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint11.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint11.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint11.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 483.4357 410.5006)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint10.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint10.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint10.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 591.7244 408.5003)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint9.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint9.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint9.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 670.1498 244.5815)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint2.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint2.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint2.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 848.1497 244.5813)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint3.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint3.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint3.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 1406.7004 243.5813)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint1.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint1.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint1.q)}</tspan>
              </text>
              ...
              <polygon className={this.getSwitch(monPoint4.i)} id="switch-nine" points="1144.8,277 1131.3,277 1131.8,240.6 1145.2,240.6 "/>
               <text transform="matrix(0.8712 0 0 1 1151.4999 241.6)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint4.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint4.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint4.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 1190.1001 402.4888)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint8.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint8.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint8.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 1279.1003 401.5812)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint7.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint7.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint7.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 1558.2004 404.5608)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint5.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint5.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint5.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 1374.0111 401.5811)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint6.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint6.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint6.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 767.4003 729.2849)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint13.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint13.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint13.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 1071.5503 729.2845)" className="st12 text">
                <tspan x="0" y="0" className="st6 st2">I: {this.getValue(monPoint14.i)}</tspan>
                <tspan x="0" y="26.2" className="st6 st2">P:{this.getValue(monPoint14.p)}</tspan>
                <tspan x="0" y="52.4" className="st6 st2">Q:{this.getValue(monPoint14.q)}</tspan>
              </text>
              ...
              <text transform="matrix(0.8712 0 0 1 1484.0996 344)" id="three-title" className="non-stroke st9 st2">
                U：<tspan className="text">{this.getValue(monPoint5.voltage)} V</tspan>
              </text>
